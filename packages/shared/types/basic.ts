...
// Real-world geographic coordinate (used by map rooms for client presence + shape geometry).
...
// Discriminator for which experience a room offers. Set by the first connecting client
// (via WS upgrade query param) and immutable for the room's lifetime.
